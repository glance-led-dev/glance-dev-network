...
Every page carries the approved SPPL shield. Current owner-uploaded team artwork is bundled for DPH, FIG, GRUF, LONG, PB, PP, RHCP, TOR, and TPOD; teams without uploaded artwork use an abbreviation badge rather than invented art.
