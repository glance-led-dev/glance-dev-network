def main(c, ctx):
    ...
    resp = http.get(
        "https://www.maxpreps.com/oh/elyria/elyria-catholic-panthers/soccer/girls/schedule/",
        ttl_seconds=900
    )
...
def ec_logo_scree(c, ctx):
    c.fill("black")
    c.image("EC-logo-64x32.png", 0, 0)
