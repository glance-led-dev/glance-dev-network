...
The stadiums college football is played in, drawn as pixel art in each
school's colours, with the gameday stories that make each one loud.
...
- **School**: one of 58 FBS programs, or ALL SCHOOLS, which moves to a new
  stadium every 20 minutes.

No network and no key. The data is built into the app. Capacities are the
listed figures for the 2026 season. Where the sources disagree (Army's
